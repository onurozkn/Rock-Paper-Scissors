...
const gameReady = () => {
    ...
    const win = () => {
      ...
      winnerScore.addEventListener('animationend', function () { this.style.animation = '' })
      ...
      winnerScore.style.animation = 'addScore 0.2s ease'
    }
    ...
    const lose = () => {
      ...
      // remove animation after
      loserScore.addEventListener('animationend', function () { this.style.animation = '' })
  
      // play audio
      score.play()
      LoseScore = LoseScore + 1
      mes.textContent = 'You lose!'
      loserScore.textContent = LoseScore
      loserScore.style.animation = 'addScore 0.2s ease'
    }
